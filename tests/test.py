...
client = OpenAI(api_key=get_env("STT_API_KEY"), base_url=get_env("STT_BASE_URL"))

file_path = Path(
    "D:\\Learn\\langchain\\demo\\backend\\storage\\attachments\\5f269ddd9fe244c9be0b1bb4c0337a38\\voice_113315.webm"
)
